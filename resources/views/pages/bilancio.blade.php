...
@section('content')
    ...
    <div class="mb-8 bg-gradient-to-r from-sky-50 to-blue-50 rounded-2xl border border-sky-100 p-8">
        <h1 class="text-4xl font-extrabold text-slate-800 mb-2">Bilancio sociale</h1>
        <p class="text-slate-600 text-lg">Trasparenza e rendicontazione dell'attività di ASCAI Bologna</p>
    </div>
