                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-600">
                        ...
                        <div class="flex items-center gap-3">
                            <!-- Facebook -->
                            <a href="#" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-700 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors" title="Facebook">
                            ...
                            <!-- Instagram -->
                            <a href="#" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-700 hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 rounded-lg flex items-center justify-center transition-all" title="Instagram">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- TikTok -->
                            <a href="#" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-700 hover:bg-black rounded-lg flex items-center justify-center transition-colors" title="TikTok">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- X (Twitter) -->
                            <a href="#" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-700 hover:bg-black rounded-lg flex items-center justify-center transition-colors" title="X">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- WhatsApp -->
                            <a href="#" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-slate-700 hover:bg-green-600 rounded-lg flex items-center justify-center transition-colors" title="WhatsApp">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
